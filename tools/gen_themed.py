...
LEVELS = {
    ...
    "killbot": dict(
        ...
        motifs=[("glitch", dict(rows=30)),
                ...
                ("motes", dict(n=60, twinkle=0.3))]),
    "aerial-gleam": dict(
        seed=26, label="Pale blades of light over distant peaks in cyan and violet",
        c=dict(bg1="#12335e", bg2="#081a33", deep="#05101f", a1="#56d8ff",
               a2="#b78cff", hi="#f2fbff"),
        motifs=[("blade", dict(n=6), dict(cls="mo-drift", dur="21s", dx=-70, dy=0)),
                ("peaks", dict(y=0.88, amp=110)),
                ("tris", dict(n=12), dict(cls="mo-bob", dur="8s", dy=14)),
    ...
    "wow": dict(
        ...
        c=dict(bg1="#141b45", bg2="#0a0e28", deep="#070a1c", a1="#ff4fa3",
               a2="#4fd8ff", hi="#f0f2ff"),
        motifs=[("nebula", dict(n=7), dict(cls="mo-drift", dur="52s", dx=-60, dy=26)),
                ("orb", dict(cx=0.7, cy=0.36, r=0.14),
                 dict(cls="mo-breathe", dur="7s")),
                ("burst", dict(cx=0.28, cy=0.5, n=16, r=0.34),
                 dict(cls="mo-spin-r", dur="96s")),
                ("confetti", dict(n=50), dict(cls="mo-bob", dur="10s", dy=18)),
                ("motes", dict(n=160, twinkle=0.5))]),
    "digital-descent": dict(
        seed=30, label="Green terminal glitch tearing down through cyan structure",
        c=dict(bg1="#0a2e1c", bg2="#06180e", deep="#04100a", a1="#3cff9d",
               a2="#00c8ff", hi="#e6ffee"),
        motifs=[("glitch", dict(rows=26)),
                ("columns", dict(n=5), dict(cls="mo-bob", dur="12s", dy=20)),
                ("speedlines", dict(n=40),
                 dict(cls="mo-drift", dur="9s", dx=0, dy=150)),
                ("slabs", dict(n=3)),
                ("motes", dict(n=80, twinkle=0.4))]),
