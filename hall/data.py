...
def validate_levels(levels: list[dict], root: pathlib.Path) -> list[str]:
    ...
    for lv in levels:
        ...
        # Rule 7: the themed tier now carries art of its own (generated by
        # tools/gen_themed.py), but still owns no bespoke fragment or
        # stylesheet — that is what separates the two tiers.
